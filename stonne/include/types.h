...
/////
enum Layer_t{CONV, MAX_POOL, AVG_POOL, FC, GEMM, SPARSE_DENSE};
enum ReduceNetwork_t{ASNETWORK, FENETWORK, TEMPORALRN};
enum MultiplierNetwork_t{LINEAR, OS_MESH};
/////
enum MemoryController_t{MAERI_DENSE_WORKLOAD, SIGMA_SPARSE_GEMM, MAGMA_SPARSE_DENSE, TPU_OS_DENSE, POOL_DENSE_WORKLOAD};
