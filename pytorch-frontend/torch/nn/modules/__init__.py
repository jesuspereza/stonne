...
from .simulatedPooling import SimulatedMaxPool2d, SimulatedAvgPool2d
...
__all__ = [
    ...
    'AdaptiveAvgPool2d', 'AdaptiveAvgPool3d', 'SimulatedMaxPool2d', 'SimulatedAvgPool2d', 'TripletMarginLoss', 'ZeroPad2d', 'ConstantPad1d', 'ConstantPad2d',
